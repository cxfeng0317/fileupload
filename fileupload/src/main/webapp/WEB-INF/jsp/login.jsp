	...
	<div class="panel login-panel">
		<form role="form" method="post" action="login">
			...
			<div class="form-group login-text" style="text-align: left;">
				<label>用户名:</label>
				<input type="text" class="form-control" name="userAccount" value="${USER_INFO.username }" placeholder="请输入您的用户名"
					required autofocus>
			</div>
			<div class="form-group login-text" style="text-align: left;">
				<label>密&nbsp;&nbsp;码:</label>
				<input type="password" class="form-control" name="userPass" value="${USER_INFO.userpass }" placeholder="请输入您的密码"
					required>
			</div>

			<div class="form-group login-text" style="text-align: left;">
				<label>验证码:&nbsp;</label>
				<input class="form-control login-inputcode" type="text" name="codetext" onblur="check()" id="codeInput" />
				&nbsp;&nbsp;&nbsp;
				<img id="code" src="safecode" onclick="changecode()" style="width: 100px; height: 30px;">
			...
			<div class="form-group login-text" style="text-align: center;">
				<h3>
					<a href="toregist">注册登录</a>
				</h3>
			</div>

			<button class="btn btn-lg btn-primary btn-block login-text" disabled="disabled" id="goBtu" type="submit">登录</button>
		</form>
	</div>
